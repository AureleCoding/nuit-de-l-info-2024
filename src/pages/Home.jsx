            ...
            <div className={"content"}>
                <div className={"left"}>
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButton path={"./static/Image/Sommaire/body_respiration.png"} id={"respiration"}/>
                        <TextWithButton
                    ...
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButton path={"./static/Image/Sommaire/microbiote2.png"} id={"vie"}/>
                        <TextWithButton
                    ...
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButton path={"./static/Image/Sommaire/blood.png"} id={"courant"}/>
                        <TextWithButton
                    ...
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButton path={"./static/Image/Sommaire/estomax.png"} id={"pollution"}/>
                        <TextWithButton
                ...
                <div className={"right"}>
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButtonR path={"./static/Image/Sommaire/wave.png"}/>
                        <TextWithButtonR
                    ...
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButtonR path={"./static/Image/Sommaire/microbiote.png"}/>
                        <TextWithButtonR
                    ...
                    <div style={{display: "flex", flexDirection: "row"}}>
                        <BubbleButtonR path={"./static/Image/Sommaire/flux.png"}/>
                        <TextWithButtonR
